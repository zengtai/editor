...
/* 数据获取设置 */
export const RENEW_DATA_FROM_REMOTE = false; // 设置为 true 强制获取远程源最新数据
export const RENEW_DATA_LOCAL = false; // 设置为 true 强制获取远程源最新数据
...
export const TOP_GAMES = [
  { appid: `BoardTheTrain`, order: 1 },
  { appid: `HiTaxi`, order: 2 },
  { appid: `MergeGuns3D`, order: 3 },
  { appid: `MrBullet`, order: 4 },
  { appid: `TrafficRun`, order: 5 },
  { appid: `SplittingCells`, order: 6 },
  { appid: `TrainIsComing`, order: 7 },
  { appid: `BestSniper`, order: 8 },
  { appid: `BestShooter`, order: 9 },
  { appid: `CrazyMoto`, order: 10 },
]; // 首推游戏
